...
# Обновлено: 2025-06-13 11:47 UTC
...
>
> - *Короткая (is.gd):* `https://is.gd/MC95eU`
...
> **Альтернативные ссылки:**
>
> - *Короткая (is.gd):* `https://is.gd/dEf55Q`
...
> **Альтернативные ссылки:**
>
> - *Короткая (is.gd):* `https://is.gd/DJDSZy`
> - *CDN (jsDelivr):* `https://cdn.jsdelivr.net/gh/Lorax121/everyday_epg_update@main/data/epg.xml` (Короткая: `https://is.gd/G6TrqM`)
...
> **Альтернативные ссылки:**
>
> - *Короткая (is.gd):* `https://is.gd/K7V542`
...
> **Альтернативные ссылки:**
>
> - *Короткая (is.gd):* `https://is.gd/wjDzEO`
